...
# Тест 11: Неверный тип данных в графе "возраст"
def test_add_new_pet_with_invalid_age_data(name='Мурзик', animal_type='сибирский', age='-1000', pet_photo='images/photo3.jpg'):
...
# Тест 12: Отсутствующий файл загрузки
def test_set_null_photo(name='Мурзик', animal_type='сибирский', age='-1000', pet_photo=''):
